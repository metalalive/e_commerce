...
def monkeypatch_django_error_view_production():
    ...
    def patched_page_not_found(
        ...
        fn = _lookup_response_render_func(
            request=request, default_func=page_not_found_html, func_map=func_map
        )
    ...
    def patched_server_error(request, template_name=ERROR_500_TEMPLATE_NAME):
        ...
        fn = _lookup_response_render_func(
            request=request, default_func=server_error_html, func_map=func_map
        )
