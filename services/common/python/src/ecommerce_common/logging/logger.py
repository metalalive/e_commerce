...
class ExtendedLogger(logging.Logger):
    ...
    def _log(self, level, msg, args, exc_info=None, extra=None, stack_info=False,
        ...
        if request:
            ...
            _extra = {"req_ip": client_ip, "req_mthd": request.method, "uri": request.get_full_path()}
        ...
        super()._log(level=level, msg=msg, args=args, exc_info=exc_info, extra=extra,
