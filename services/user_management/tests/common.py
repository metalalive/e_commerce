...
_fixtures = {
    ...
    GenericUserProfile: [
        ...
        for idx in range(1, 1 + num_login_profiles)
    ],
    Role: [  # including superuser role and staff role
        {
            "id": idx,
            "name": "my role %s" % "".join(random.choices(string.ascii_letters, k=8)),
        }
    ...
    QuotaMaterial: [
        {
            ...
            "mat_code": QuotaMaterial._MatCodeOptions.MAX_NUM_EMAILS.value,
        },
        {
            "id": 2,
            "app_code": AppCodeOptions.user_management,
            "mat_code": QuotaMaterial._MatCodeOptions.MAX_NUM_GEO_LOCATIONS.value,
        },
        {
            "id": 3,
            "app_code": AppCodeOptions.user_management,
            "mat_code": QuotaMaterial._MatCodeOptions.MAX_NUM_PHONE_NUMBERS.value,
        },
    ...
    GeoLocation: [
        {
            ...
            "locality": "Heiderburg",
            "street": "Generic Size",
            "detail": "PitaProfession House",
            "floor": 3,
            "description": "AutoFarm101",
        },
        {
            "id": 4,
            "country": "CZ",
            "province": "Buno",
            "locality": "Gurrigashee",
            "street": "Old castle ave",
            "detail": "Agile Lane, 4-8-1",
            "floor": -1,
            "description": "Smart connected Handle Bar studio",
        },
        {
            "id": 5,
            "country": "SG",
            "province": "cannotBeEmpty",
            "locality": "Chang-i",
            "street": "Tok-Hua rd.",
            "detail": "Tyson mansion",
            "floor": 8,
            "description": "contexturize marshall language",
        },
        {
            "id": 6,
            "country": "PT",
            "province": "Leewisky",
            "locality": "Lisbon",
            "street": "green straw st",
            "detail": "Booming Lane 13-6",
            "floor": 7,
            "description": "Herb nursery",
        },
        {
            "id": 7,
            "country": "ID",
            "province": "Gunung Surawesi",
            "locality": "Gyrueoq0",
            "street": "Steamer road 199",
            "detail": "Broken Bay",
            "floor": 1,
        ...
        },
        {
            ...
            "country": "IN",
            "province": "Udaipur",
            "locality": "Jenkistania",
            "street": "Taiwan Independent ave. 426",
            "detail": "be independent",
            "floor": 1,
            "description": "Human Right NGO",
        },
    ],
}  ## end of _fixtures
...
def _setup_login_account(account_data, profile_obj, roles=None, expiry=None):
    ...
    for role in roles:
        data_kwargs = {
            "expiry": gen_expiry_time(minutes_valid=expiry),
            "role": role,
            "approved_by": login_user_profile,
        }
...
class UserNestedFieldSetupMixin:
    ...
    def _gen_roles(self, role_objs, num=None, serializable=True):
        ...
        out = []
        if num > 0:
            roles_gen = listitem_rand_assigner(
                list_=role_objs, min_num_chosen=num, max_num_chosen=(num + 1)
            )
    ...
    def _gen_quota(self, quota_mat_objs, num=None, serializable=True):
        ...
        out = []
        if num > 0:
            materials_gen = listitem_rand_assigner(
                list_=quota_mat_objs, min_num_chosen=num, max_num_chosen=(num + 1)
            )
    ...
    def _gen_locations(self, num=None):
        ...
        out = []
        if num > 0:
            data_gen = listitem_rand_assigner(
                list_=_fixtures[GeoLocation],
                min_num_chosen=num,
