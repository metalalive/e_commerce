...
class RenderMailContentTestCase(unittest.TestCase):
    ...
    def test_ok(self):
        ...
        msg_data = {"func_name":"user-preference-history", "syntax":"zero-sized type",
        ...
        self.assertGreater(actual_content.index("zero-sized type could lead to undefined behaviour"), 0)
    ...
    def test_render_error(self):
        ...
        subject_data = {"someone_else": "brother", "thing":"food"} # will cause key error
