...
from .views.auth import (
    LoginAccountCreateView,
    RefreshAccessTokenView,
    UsernameRecoveryRequestView,
    UnauthPasswordResetRequestView,
    UnauthPasswordResetView,
    AuthPasswdEditAPIView,
    AuthUsernameEditAPIView,
    LoginView,
    LogoutView,
    PermissionView,
    JWKSPublicKeyView,
...
urlpatterns = [
    ...
    path(
        UserMgtCfg.api_url[RefreshAccessTokenView.__name__],
    ...
    path(
        UserMgtCfg.api_url[AccountDeactivationView.__name__],
        AccountDeactivationView.as_view(),
    ),
    path(
        UserMgtCfg.api_url[LoginAccountCreateView.__name__],
        LoginAccountCreateView.as_view(),
    ),
    path(
        UserMgtCfg.api_url[UsernameRecoveryRequestView.__name__],
        UsernameRecoveryRequestView.as_view(),
    ),
    path(
        UserMgtCfg.api_url[UnauthPasswordResetRequestView.__name__],
        UnauthPasswordResetRequestView.as_view(),
    ),
    path(
        UserMgtCfg.api_url[UnauthPasswordResetView.__name__],
        UnauthPasswordResetView.as_view(),
    ),
    path(
        UserMgtCfg.api_url[AuthPasswdEditAPIView.__name__],
        AuthPasswdEditAPIView.as_view(),
    ),
    path(
        UserMgtCfg.api_url[AuthUsernameEditAPIView.__name__],
        AuthUsernameEditAPIView.as_view(),
    ),
