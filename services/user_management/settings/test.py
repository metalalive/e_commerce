...
ks_cfg["filepath"] = BASE_DIR.joinpath("tmp/cache/test/jwks/privkey/current.json")  # noqa : F405
ks_cfg["flush_threshold"] = 4
ks_cfg = AUTH_KEYSTORE["persist_pubkey_handler"]["init_kwargs"]  # noqa : F405
ks_cfg["filepath"] = BASE_DIR.joinpath("tmp/cache/test/jwks/pubkey/current.json")  # noqa : F405
ks_cfg["flush_threshold"] = 4
