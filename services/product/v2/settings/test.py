...
DATABASES["confidential_path"] = "backend_apps.databases.product_test_service_v2"  # noqa: F405

KEYSTORE["persist_secret_handler"] = {  # noqa: F405
...
KEYSTORE["persist_pubkey_handler"] = {  # noqa: F405
    "module_path": "ecommerce_common.auth.keystore.JWKSFilePersistHandler",
    "init_kwargs": {
