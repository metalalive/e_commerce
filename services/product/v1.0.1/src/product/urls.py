...
from .views.base  import TagView, TaggedSaleableView, AttributeTypeView, SaleableItemView, SaleablePackageView
...
urlpatterns = [
    ...
    path(ProductConfig.api_url[TaggedSaleableView.__name__],  TaggedSaleableView.as_view() ),
