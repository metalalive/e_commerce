...
void app_load_envvars(app_envvars_t *);
int  appcfg_parse_pid_file(json_t *obj, app_cfg_t *);
int  appcfg_parse_errlog_path(json_t *obj, app_cfg_t *);
int  appcfg_parse_num_workers(json_t *obj, app_cfg_t *);
int  appcfg_parse_local_tmp_buf(json_t *obj, app_cfg_t *);
