...
typedef asa_op_localfs_cfg_t *(*cache_init_fn_t)(
...
int api_filefetch_start_caching(
    h2o_req_t *, h2o_handler_t *, app_middleware_node_t *, json_t *spec, json_t *err_info, cache_init_fn_t,
    cache_proceed_fn_t
);

void api_init_filefetch__deinit_common(
    h2o_req_t *, h2o_handler_t *, app_middleware_node_t *, json_t *qparams, json_t *res_body
);
