...
#define MOCK_USRBUF_DIRPATH     UTEST_ASALOCAL_BASEPATH "/426"
#define MOCK_USRREQ_DIRPATH     MOCK_USRBUF_DIRPATH "/d150de7a"
#define MOCK_CRYPTOKEY_FILEPATH MOCK_USRREQ_DIRPATH "/" HLS_CRYPTO_KEY_FILENAME
...
#undef RUNNER
        ...
        assert_that(
            json_integer_value(json_object_get(_metadata, "upld_req")), is_equal_to(MOCK_UPLD_REQ_1_ID)
        );
