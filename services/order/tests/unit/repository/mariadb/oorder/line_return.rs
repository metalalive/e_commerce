...
use crate::repository::in_mem::oorder::oline_return::{
    ut_setup_ret_models, ut_setup_ret_models_ks2, ut_setup_fetch_by_ctime,
    fetch_by_ctime_common, fetch_by_oid_ctime_common
};
...
async fn fetch_request_by_ctime_ok()
{
    ...
    fetch_by_oid_ctime_common( repo.clone(), "50ba",
    ...
    fetch_by_oid_ctime_common( repo, "beef",
