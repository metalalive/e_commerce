...
async fn save_ok_1() {
    ...
    let new_data: AppInMemUpdateData = {
        ...
        let t1 = {
            ...
            let row = ["tee", "0.076", "1827", "r6p0"]
                .into_iter()
                .map(String::from)
                .collect();
            t.insert("G802".to_string(), row);
            let row = ["hie", "1.3689", "20", "r6p1"]
                .into_iter()
                .map(String::from)
                .collect();
        ...
        let t2 = {
            let mut t = HashMap::new();
            let row = ["mie", "0.076", "llama"]
                .into_iter()
                .map(String::from)
                .collect();
            t.insert("1800".to_string(), row);
            let row = ["man", "1.368", "alpaca"]
                .into_iter()
                .map(String::from)
                .collect();
    ...
    let fetching_keys: AppInMemFetchKeys = {
        let mut out = HashMap::new();
        let t1 = ["initDee", "GIj0e", "U8ry1g"]
            .into_iter()
            .map(String::from)
            .collect();
        let t2 = ["93orwjtr", "9eujr"]
            .into_iter()
            .map(String::from)
            .collect();
        let t3 = ["18o0", "1680", "1800"]
            .into_iter()
            .map(String::from)
            .collect();
        out.insert(UT_TABLE_LABEL_A.to_string(), t1);
...
async fn save_ok_2() {
    ...
    let new_data: AppInMemUpdateData = {
        ...
        let t1 = {
            ...
            let row = ["tee", "0.076", "1827", "r6p0"]
                ...
                .collect();
            t.insert("G802".to_string(), row);
            let row = ["sbitz", "0.01101001", "59", "r4p10"]
                .into_iter()
                .map(String::from)
                .collect();
    ...
    let new_data: AppInMemUpdateData = {
        ...
        let t1 = {
            let mut t = HashMap::new();
            let row = ["shreding", "0.1011", "52", "r5p6"]
                .into_iter()
                .map(String::from)
                .collect();
            t.insert("G802".to_string(), row); // modify existing row
            let row = ["Hit", "1.816", "107", "r6p4"]
                .into_iter()
                .map(String::from)
                .collect();
...
async fn filter_key_ok() {
    ...
    let init_data: [Vec<String>; 4] = [
        ...
        ["shaw", "10.14", "122", "r4p6"]
            ...
            .map(String::from)
            .collect(),
        ["sbitz", "0.01101001", "59", "r4p10"]
            .into_iter()
            .map(String::from)
            .collect(),
        ["tito", "0.01101001", "59", "watching"]
            .into_iter()
            .map(String::from)
            .collect(),
    ];
