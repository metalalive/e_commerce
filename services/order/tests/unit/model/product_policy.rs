...
fn validate_newdata_ok() {
    let newdata = vec![
        ProductPolicyDto{ product_type:ProductType::Item, product_id:123, min_num_rsv:None,
            warranty_hours:480,  auto_cancel_secs:3600, max_num_rsv:None },
        ProductPolicyDto{ product_type:ProductType::Package, product_id:124, min_num_rsv:None,
            warranty_hours:478,  auto_cancel_secs:3597, max_num_rsv:None }
    ];
...
{ 
    let newdata = vec![
        ProductPolicyDto{ product_type:ProductType::Item, product_id:170, min_num_rsv:Some(5),
            warranty_hours:500,  auto_cancel_secs:360, max_num_rsv:None },
        ProductPolicyDto{ product_type:ProductType::Package, product_id:127, min_num_rsv:None,
            warranty_hours:500,  auto_cancel_secs:360, max_num_rsv:None },
        ProductPolicyDto{ product_type:ProductType::Package, product_id:123, min_num_rsv:None,
            warranty_hours:0x7fff_ffffu32,  auto_cancel_secs:3600, max_num_rsv:None },
        ProductPolicyDto{ product_type:ProductType::Item, product_id:124, min_num_rsv:Some(12),
            warranty_hours:478,  auto_cancel_secs:0x7fff_ffffu32, max_num_rsv:Some(2) }
    ];
    let result = ProductPolicyModelSet::validate(&newdata);
...
fn update_instance_ok() {
    let init_data = [
        ProductPolicyModel {product_type:ProductType::Item, product_id:20903, auto_cancel_secs:731,
           warranty_hours:271, is_create:false, max_num_rsv:0, min_num_rsv:0 },
        ProductPolicyModel {product_type:ProductType::Package, product_id:144, auto_cancel_secs:380,
           warranty_hours:30098, is_create:false, max_num_rsv:8, min_num_rsv:0 },
        ...
        ProductPolicyModel {product_type:ProductType::Package, product_id:144, auto_cancel_secs:3597,
           warranty_hours:478, is_create:false, max_num_rsv:0, min_num_rsv:0 },
        ProductPolicyModel {product_type:ProductType::Item, product_id:123, auto_cancel_secs:3600,
           warranty_hours:480, is_create:true, max_num_rsv:26, min_num_rsv:15 },
    ];
    let newdata = vec![
        ProductPolicyDto{ product_type:ProductType::Item, product_id:123,
            warranty_hours:480,  auto_cancel_secs:3600, max_num_rsv:Some(26), min_num_rsv:Some(15) },
        ProductPolicyDto{ product_type:ProductType::Package, product_id:144,
            warranty_hours:478,  auto_cancel_secs:3597, max_num_rsv:None, min_num_rsv:None }
    ];
