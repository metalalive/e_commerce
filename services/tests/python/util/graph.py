...
from common.util.python.graph import is_graph_cyclic, path_exists
...
class CycleDetectionTestCase(unittest.TestCase):
    ...
    def test_cylic_graph(self):
        ...
        self.assertIn(2, loop_node_list,)
        graph = {
        ...
        self.assertTrue(has_cycle)
        self.assertIn(2, loop_node_list,)
        self.assertIn(3, loop_node_list,)
        graph = {
        ...
        self.assertIn(2, loop_node_list,)
        self.assertIn(3, loop_node_list,)
        self.assertIn(4, loop_node_list,)
