...
from common.auth.keystore import RSAKeygenHandler
...
class RSAkeygenTestCase(unittest.TestCase):
    ...
    def test_fail(self):
        err = capture_error(testcase=self, err_cls=ValueError, exe_fn=self._exe_fn,
    ...
    def test_ok(self):
        ...
        expect_key_types = {'public': ['e', 'n'], 'private': ['dq', 'e', 'qp', 'd', 'dp', 'q', 'p', 'n']}
...
class JwkRSAkeygenTestCase(unittest.TestCase):
    ...
    def test_ok(self):
        ...
        expect_key_types = {'public': ['e', 'n'], 'private': ['dq', 'e', 'qi', 'd', 'dp', 'q', 'p', 'n']}
        for key_type, elements_label in expect_key_types.items():
