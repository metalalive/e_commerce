...
#define  NUM_ARGS  (NUM_FNS << 1)
    ...
    app_middleware_fn  expect_fn_order[] = {
        test_handler_node_2, test_handler_node_5, test_handler_node_1,
        test_handler_node_7, test_handler_node_4
    };
    app_middleware_node_t *head = app_gen_middleware_chain( NUM_ARGS,
            test_handler_node_2, MANDATORY_EXE_FLG,    test_handler_node_5, MANDATORY_EXE_FLG,
            test_handler_node_1, MANDATORY_EXE_FLG,    test_handler_node_7, MANDATORY_EXE_FLG,
            test_handler_node_4, MANDATORY_EXE_FLG  );
...
#define  EXPECT_FN_ORDER \
    test_handler_node_2, MANDATORY_EXE_FLG,  test_handler_node_5, MANDATORY_EXE_FLG, \
    test_handler_node_1, MANDATORY_EXE_FLG,  test_handler_node_7, MANDATORY_EXE_FLG, \
    test_handler_node_4, MANDATORY_EXE_FLG,  test_handler_node_3, MANDATORY_EXE_FLG, \
    test_handler_node_6, MANDATORY_EXE_FLG
#define  NUM_FNS  7
#define  NUM_ARGS  (NUM_FNS << 1)
