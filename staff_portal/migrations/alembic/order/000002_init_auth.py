...
from order.models import OrderInvoice, OrderReceipt, OrderLineReturn
...
resource_classes = (OrderInvoice, OrderReceipt, OrderLineReturn)
auth_resource_labels = tuple(map(lambda cls:cls.__name__.lower(), resource_classes))
quota_mat_classes = (OrderInvoice, OrderReceipt,)
