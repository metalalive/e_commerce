...
class ExtendedCsrfViewMiddleware(CsrfViewMiddleware):
    ...
    def _reject(self, request, reason):
        ...
        result = accept_mimetypes_lookup(http_accept=request.headers['accept'],
...
#class ExtendedCsrfApiMiddleware(ExtendedCsrfViewMiddleware):
#
#    def _reject(self, request, reason):
...
#        renderers = [renderer() for renderer in supported_renderer_classes]
