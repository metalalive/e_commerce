...
type RepoFetchCallArgType = (u32, Vec<(u8,u64)>);
    ...
    fn _clone_fetched_items(&self, src:&Vec<ProductPriceModel>) -> Vec<ProductPriceModel>
    {
        src.iter().map(|g| {
            ProductPriceModel {
                ...
                product_id: g.product_id, product_type: g.product_type,
...
async fn create_ok ()
{
    ...
    let creating_products = vec![
        ProductPriceEditDto { price:389, product_type:1, product_id:2379,
        ...
        ProductPriceEditDto { price:51, product_type:2, product_id:2642,
...
async fn update_ok ()
{
    ...
    let updating_products = vec![
        ...
        ProductPriceEditDto { price:1155, product_type:2, product_id:2613,
...
async fn save_error ()
{
    ...
    let updating_products = vec![
        ProductPriceEditDto { price:183, product_type:2, product_id:9914,
            start_after: DateTime::parse_from_rfc3339("2022-11-23T09:13:41+07:00").unwrap().into(),
            end_before: DateTime::parse_from_rfc3339("2023-10-12T21:23:00+08:00").unwrap().into(),
        },
    ];
